...
[Procedure]
1. In extended/manifest.json, find candidate items related to the question (first-pass routing by name/subgroup/group; in criteria-index.csv, group is the domain column and subgroup is the bunya column).
